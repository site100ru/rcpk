...
if($_POST){
    function getCaptchaUsername($SecretKey){
    ...
    $Return = getCaptchaUsername($_POST['g-recaptcha-response']);
    ...
    if($Return->success == true && $Return->score > .5){
        ...
        mail("info@rcpk62.ru, vasilyev-r@mail.ru", "Сообщение с сайта", $message);
