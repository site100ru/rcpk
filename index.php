...
<body <?php body_class(); ?>>
                    ...
                    <div class="mosaic-popup__inner-data mosaic-popup__inner-data--u-ibozsrwvn">
                        ...
                        <div class="mosaic-form mosaic-form--u-iyjjmcepo">
                            <form action="<?php echo get_template_directory_uri(); ?>/assets/mails/callback-username.php" class="mosaic-form__form mosaic-form__form--u-iwsx1397a" method="POST">
                                ...
                                <input type="hidden" id="g-recaptcha-response-username" name="g-recaptcha-response">
                                <button type="submit" class="mosaic-form__button mosaic-form__button--u-ihqwpp16f">
                                    <span class="button__text button__text--u-ixtzflqi8">
                                        <span class="text-block-wrap-div">Отправить</span>
                                    </span>
                    ...
                    <div class="mosaic-popup__inner-data mosaic-popup__inner-data--u-ibozsrwvn">
                        ...
                        <div class="mosaic-form--u-ijpswxniq mosaic-form--u-ijpswxniq-1 mosaic-form--u-iyjjmcepo">
                            <form action="<?php echo get_template_directory_uri(); ?>/assets/mails/course-form.php" class="mosaic-form__form mosaic-form__form--u-ik5179561" method="POST">
                                ...
                                <input type="hidden" id="g-recaptcha-response-course" name="g-recaptcha-response">
                            ...
                            <div class="div div--u-if8m6hfjg">
                                <div class="list list--u-id9txhv53">
                                    <div class="list__item list__item--u-izm0hwedg">
                                        <a target="_blank" href="https://trade43.ru/skolkovo" target="_blank">
 ...
 -->
                    ...
                    <div class="section section--u-i9t9jamjn">
                        ...
                        <div class="div div--u-ie6zm4gfm">
                            ...
                            <div class="text text--u-iz4awmpyc">
                                <span class="text-block-wrap-div">Учебные программы разработаны в соответствии с законодательством РФ. Индивидуальное сопровождение.</span>
                            </div>
                        </div>
                    </div>
            ...
            <?php include(get_template_directory() . '/template-parts/catalog-output/catalog-output.php'); ?>
            ...
            if (!empty($licenses)) : ?>
                                ...
                                <div class="blocklist__items_wrapper blocklist__items_wrapper--u-ingho8az2">
                                    <div class="blocklist__list blocklist__list--u-iditg5wka">
                                        ...
                                        <?php foreach ($licenses as $index => $license) :
                                            $image_url = !empty($license['img_url']) ? $license['img_url'] : '';
                                            $pdf_url   = !empty($license['pdf_url']) ? $license['pdf_url'] : '';
                                            $title     = !empty($license['title'])   ? $license['title']   : 'Лицензия ' . ($index + 1);
                                        ...
                                        ?>
                                            <div class="blocklist__item__outer blocklist__item__outer--u-i7u8q7ljz">
                                                <div class="blocklist__item blocklist__item--u-iz82wxbiw">
                                                    ...
                                                    <?php else : ?>
                                                        <!-- Если PDF нет — открываем изображение в галерее -->
                                                        <div class="imageFit imageFit--u-ividt7p2w photo-swipe-image-nc cursor-pointer"
                                                            data-gallery-trigger="gallery-licenses"
                                                    ...
                                                    <?php if (!empty($title)) : ?>
                                                        <div class="blocklist__item_title" style="text-align: center; margin-top: 8px; font-size: 13px;">
                ...
                <!-- Скрытые ссылки для галереи (только карточки без PDF) -->
                <div style="display: none;">
                    <?php foreach ($licenses as $license) :
                        if (empty($license['img_url']) || !empty($license['pdf_url'])) continue;
                    ?>
                        <a href="<?php echo esc_url($license['img_url']); ?>" data-gallery="gallery-licenses"></a>
                    <?php endforeach; ?>
                </div>
